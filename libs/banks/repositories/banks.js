...
function getBankDataQuery(iban) {
	return [
		"SELECT BD.withrawal, I.IBAN, B.bankName",
...
function getBankData(iban) {
	...
	var query = getBankDataQuery(iban);

	def.resolve([{Amount: 5000, IBAN: '34567890', bankName: 'Reiffeisen'}]);
...
module.exports = {
	    ...
	    getBankDataQuery: getBankDataQuery
};